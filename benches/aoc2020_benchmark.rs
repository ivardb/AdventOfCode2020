...
pub fn day22_benchmark(c : &mut Criterion) {
    let input = include_str!("../src/days/day22/input");
    c.bench_function("Day 22, Part 1", |b| b.iter(|| criterion_bench_part1(22, &input)));
...
pub fn day24_benchmark(c : &mut Criterion) {
    let input = include_str!("../src/days/day24/input");
    c.bench_function("Day 24, Part 1", |b| b.iter(|| criterion_bench_part1(24, &input)));
    c.bench_function("Day 24, Part 2", |b| b.iter(|| criterion_bench_part2(24, &input)));
}

pub fn day25_benchmark(c : &mut Criterion) {
    let input = include_str!("../src/days/day25/input");
